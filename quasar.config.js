...
module.exports = configure(function (ctx) {
  ...
  switch (process.env.STAGE) {
    ...
    default:
      ...
      loginURL = 'http://127.0.0.1:4000/auth'
  }
  ...
  return {
    ...
    build: {
      env: {
        DEPLOYMENT: ctx.dev ? 'Development' : process.env.STAGE,
        API_URL: apiURL,
        LOGIN_URL: loginURL
      },
    ...
    pwa: {
      ...
      manifest: {
        ...
        short_name: 'Plexus Frontend',
        description: 'Frontend for the Plexus Platform',
        display: 'standalone',
